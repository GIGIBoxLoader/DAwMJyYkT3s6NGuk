...
bind = "q"
if outspp == true then
	command_logged.Text = "We are whatching you... ;)"
...
elseif CommandBar.Text == "down-ACGFastDisb-update" then
	if _G.Settings.ACGFastDisb == true then
		command_logged.Text = "User Error: ACGFastDisb is already downloaded."
		elseif _G.Settings.ACGFastDisb == false then
		command_logged.Text = "Welcome to ACGFastDisb Lib \n\nCreated by AnomalieCli \nLib created by Schoulde \n\n Completed |#|"
		wait(3)
		command_logged.Text = "Welcome to ACGFastDisb Lib \n\nCreated by AnomalieCli \nLib created by Schoulde \n\n Completed |###############|"
		wait(4)
			_G.Settings.ACGFastDisb = true
			saveSettings()
		command_logged.Text = "Welcome to ACGFastDisb Lib \n\nCreated by AnomalieCli \nLib created by Schoulde \n\n Completed |######################|"
		wait(2)
		command_logged.Text = "Download complete, Use ACGHelp to see help"

	end
elseif CommandBar.Text == "ACGHelp" then

		if _G.Settings.ACGFastDisb == true then
		command_logged.Text = "Welcome to ACGFastDisb Lib \n\nCreated by AnomalieCli \nLib created by Schoulde \n\nCommands: acgfast-disable or acgfast-enable \n\nWorks without root!"
		elseif _G.Settings.ACGFastDisb == false then
		command_logged.Text = "No command found. Please execute help to get info and the commands. \nError: -17"
	end
elseif CommandBar.Text == "acgfast-disable" then
		if _G.Settings.ACGFastDisb == true then
		command_logged.Text = "Disabling ACG Security Systems..."
		wait(3)
		
			_G.Settings.ACGSec = false
			saveSettings()
		command_logged.Text = "You have Disabled ACG Security"
		wait(3)
...
elseif CommandBar.Text == "acgfast-enable" then
		if _G.Settings.ACGFastDisb == true then
		command_logged.Text = "Enabling ACG Security Systems..."
		wait(6)
		command_logged.Text = "You have Enabled ACG Security"
			wait(3)
	...
	elseif CommandBar.Text == "uninstall-ACGFastDisb" then
		if _G.Settings.ACGFastDisb == true then
			command_logged.Text = "`ACGFastDisb` is going to uninstall."
			command_logged.Text = "`ACGFastDisb` is going to uninstall. \n\n `ACGFastDisb` uninstalled correctly"
			_G.Settings.ACGFastDisb = false
			saveSettings()
		elseif _G.Settings.ACGFastDisb == false then
			command_logged.Text = "`ACGFastDisb` Is not in your ARCU OS, We cant uninstall it."
		end
	---------------------------------------------------
	---------------------------------------------------
	---------------------------------------------------
...
elseif CommandBar.Text == "delRoot.RootPer = true" then
		...
		command_logged.Text = "You are about to put Root."
			command_logged.Text = "Enabling root."
			_G.Settings.Root = true
			saveSettings()
		wait(1)
			_G.Settings.Root = true
			saveSettings()
...
elseif CommandBar.Text == "delRoot.RootPer = false" then
		if _G.Settings.Root == false then
			command_logged.Text = "Root is already disabled, Try putting true to enable it"
		elseif _G.Settings.Root == true then
			command_logged.Text = "Disabling root."
			_G.Settings.Root = false
			saveSettings()
			wait(4)
			command_logged.Text = "Root disabled correctly"
	end
	---------------------------------------------------
